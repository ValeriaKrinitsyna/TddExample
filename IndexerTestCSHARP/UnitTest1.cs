...
namespace IndexerTestCSHARP
{
    ...
    public class UnitTest1
    {
        ...
        {
            var indexer1 = new IndexerCSHARP(array, 1, 2);
            var indexer2 = new IndexerCSHARP(array, 0, 2);
            indexer1[0] = 100500;
        ...
        {
            Assert.Equals(typeof(ArgumentException), new IndexerCSHARP(array, -1, 3));
        }
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void FailWithWrongArguments2()
        {
            Assert.Equals(typeof(ArgumentException), new IndexerCSHARP(array, 1, -1));
        }
        [TestMethod]
        [ExpectedException(typeof(ArgumentException))]
        public void FailWithWrongArguments3()
        {
            Assert.Equals(typeof(ArgumentException), new IndexerCSHARP(array, 1, 10));
        }
        [TestMethod]
